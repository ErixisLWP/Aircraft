...
public class ImageManager {
    ...
    public static BufferedImage BACKGROUND_IMAGE_SIMPLE;
    ...
    static {
        try {
            ...
            BACKGROUND_IMAGE_SIMPLE = ImageIO.read(new FileInputStream("src/images/bg.jpg"));
            BACKGROUND_IMAGE_NORMAL = ImageIO.read(new FileInputStream("src/images/bg4.jpg"));
